...
<section id="home">
    ...
    <div class="kolom">
        ...
        <?php echo maximum_kata(ambil_isi('21'), 30) ?>
        <p><a href="<?php echo buat_link_halaman('21') ?>" class="tbl-pink">Pelajari Lebih Lanjut</a></p>
    </div>
</section>
...
<section id="courses">
    <div class="kolom">
        <p class="deskripsi"><?php echo ambil_kutipan('22') ?></p>
        <h2><?php echo ambil_judul('22') ?></h2>
        <?php echo maximum_kata(ambil_isi('22'), 30) ?>
        <p><a href="<?php echo buat_link_halaman('22') ?>" class="tbl-biru">Pelajari Lebih Lanjut</a></p>
    </div>
